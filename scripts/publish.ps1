...
#  2. Copiaza dashboard-ul (ppc-dashboard-live.html -> public/index.html) si ppc-data.js -> public/ppc-data.js.
...
Write-Host "==> 2. Copiez fisierele actualizate in public/..."
New-Item -ItemType Directory -Force -Path "public" | Out-Null
Copy-Item "ppc-dashboard-live.html" "public\index.html" -Force
Copy-Item "ppc-data.js" "public\ppc-data.js" -Force

Write-Host "==> 3. Trimit modificarile pe GitHub (GitHub Pages se actualizeaza automat)..."
git add public/index.html public/ppc-data.js
